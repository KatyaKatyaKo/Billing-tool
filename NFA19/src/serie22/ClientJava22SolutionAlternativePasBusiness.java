...
public class ClientJava22SolutionAlternativePasBusiness {
							...
							switch(choix) {
							 ...
							 case 2: 
								 ...
								 if(tabCde.retourner(numCde).getUneCommande().isEmpty()) { //Si la commande est vide après la suppression d'un article
									 ClientJava1DateUser.affiche("\n\t !!!!!!!!!!!!!ATTENTION!!!!!!!!!!!!! \n\t IL NE RESTE PLUS D'ARTICLES DANS CETTE COMMANDE \n\tVOUS ËTES SUR LE POINT DE SUPPRIMER UNE COMMANDE \n\t Voulez-vous la supprimer?\n");
									 int confirmerSuppression = ClientJava1DateUser.lireEnt("\n\t FAITES 1 pour CONFIRMER LA SUPPRESSION:\n\t FAITES 2 pour ANNULER LA SUPPRESSION  \n\t " + ":", 1, 2);
									 //CETTE LOGIQUE NE CORRESPIND PAS AU BUSINESS, C'EST FAIT POUR BUT D'EXERCICE
									 if (confirmerSuppression ==1) {
									 tabCde.supprimer(numCde); 
									 ClientJava1DateUser.affiche("\n\t LA COMMANDE A ETE SUPPRIMEE\n"); 
