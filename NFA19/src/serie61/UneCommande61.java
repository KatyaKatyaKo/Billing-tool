...
public class UneCommande61<TypeDuCode> implements InterfaceStructure <TypeDuCode, LigneDeCommande61>, Serializable { //VERIFIER SI C EST CORRECT
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	//VARIABLES D'INSTANCE
	protected Vector <LigneDeCommande61> cde = new Vector <LigneDeCommande61>();
	...
	//CONSTRUCTEUR
	public UneCommande61(TypeDuCode numCode,Vector<LigneDeCommande61> cde) {
		this.numCde = numCode;
		this.cde=cde;
		} // Constructeur 1
	
	public UneCommande61() {} //Constructeur 2
	
	//GETTER ET SETTER - 1 SEUL
	
	//Getter - Attention - getter = public Variable d'instance et pas public NameClass
	public Vector <LigneDeCommande61> getUneCommande(){return cde;}
	...
	public LigneDeCommande61 retourner(int code) { //On cherche par code dans toute la commande et ça retourne l'article //Clé étrangère		
		for (int i=0; i<taille(); i++) {
	...
	public void ajouter(LigneDeCommande61 ldc) {this.cde.addElement(ldc);}
	
	public void supprimer(LigneDeCommande61 ldc) { 
		for (int i=0; i<taille(); i++) {
	...
	public String facturer(TableArticle61 tabArt) { //Affiche l'ensemble des "factures de lignes de commande"
	...
	//NOUVELLE FONCTION 
	public float prixCommandeTTC(TableArticle61 tabArt) {
		float prix = 0;
		for (int i=0; i<taille(); i++) {
