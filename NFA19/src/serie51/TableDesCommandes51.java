...
public class TableDesCommandes51 implements  InterfaceStructure <String, UneCommande51<String>>, Serializable{ 
	/**
	 * 
	 */
	...
	public Hashtable <String, UneCommande51<String>> tabCde = new Hashtable <String, UneCommande51<String>>(); //On transforme le generique en String
	
	//Constructeur 1 Par default
	public TableDesCommandes51() {}
	
	//Constructeur 2 
	public TableDesCommandes51(Hashtable <String, UneCommande51<String>> tabCde) {this.tabCde =tabCde;}
	
	//Getters
	public Hashtable <String, UneCommande51<String>> getTabCde(){return tabCde;}
	
	//Setters
	public void setTabCde(Hashtable<String, UneCommande51<String>> tabCde)  {this.tabCde = tabCde;}
	...
	for (UneCommande51<String> cde22: tabCde.values()) {
	...
	//ajouter
	public void ajouter (UneCommande51<String> cde) {
		this.tabCde.put(cde.getCode(), cde);
	}
	
	//numero de commmande
	public UneCommande51<String> retourner (String code){
	...
	*/
	...
	public void purge (int codeArt) {
		...
		Enumeration<UneCommande51<String>> cdeEnum =  tabCde.elements();	
		while(cdeEnum.hasMoreElements()){
			UneCommande51<String> cde = cdeEnum.nextElement();
	...
	public String facturerCommandes(TableArticle51 tabArt) {
		String sc = "\n\t\t LE TOTAL des COMMANDES \n";
		String sc2 = "";
		float prixTotalFacturesTTC=0;
		//Transformer une commande en collection
				Enumeration<UneCommande51<String>> cdeEnum =  this.tabCde.elements();	
				while(cdeEnum.hasMoreElements()){
					UneCommande51<String> cde = cdeEnum.nextElement();
