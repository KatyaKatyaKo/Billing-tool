...
public class UneCommande41<TypeDuCode> { //On introduit un type generique
	...
	//CONSTRUCTEUR
	public UneCommande41(TypeDuCode numCode,Vector<LigneDeCommande41> cde) {
		this.numCde = numCode;
		this.cde=cde;
		} // Constructeur 1
	
	public UneCommande41() {} //Constructeur 2
	
	//GETTER ET SETTER - 1 SEUL
	
	//Getter - Attention - getter = public Variable d'instance et pas public NameClass
	public Vector <LigneDeCommande41> getUneCommande(){return cde;}
	
	//Setteur - Attention - setter = public Variable d'instance et pas public NameClass
	public void getUneCommande (Vector <LigneDeCommande41> cde)  {this.cde=cde;}
	...
	public LigneDeCommande41 retourner(int code) { //On cherche par code dans toute la commande et ça retourne l'article //Clé étrangère		
		for (int i=0; i<taille(); i++) {
	...
	public void ajouter(LigneDeCommande41 ldc) {this.cde.addElement(ldc);}
	...
	public String facturer(TableArticle41 tabArt) { //Affiche l'ensemble des "factures de lignes de commande"
	...
	//NOUVELLE FONCTION 
	public float prixCommandeTTC(TableArticle41 tabArt) {
		float prix = 0;
		for (int i=0; i<taille(); i++) {
