...
public class TableDesCommandes41 { 
	...
	protected Hashtable <Integer, UneCommande41<Integer>> tabCde = new Hashtable <Integer, UneCommande41<Integer>>(); //On transforme le generique en Integer
	
	//Constructeur 1 Par default
	public TableDesCommandes41() {}
	
	//Constructeur 2 
	public TableDesCommandes41(Hashtable <Integer, UneCommande41<Integer>> tabCde) {this.tabCde =tabCde;}
	
	//Getters
	public Hashtable <Integer, UneCommande41<Integer>> getTabCde(){return tabCde;}
	
	//Setters
	public void setTabCde(Hashtable<Integer, UneCommande41<Integer>> tabCde)  {this.tabCde = tabCde;}
	...
	for (UneCommande41<Integer> cde22: tabCde.values()) {
	...
	//ajouter
	public void ajouter (UneCommande41<Integer> cde) {
		this.tabCde.put(cde.getCode(), cde);
	}
	

	//numero de commmande
	public UneCommande41<Integer> retourner (int code){
	...
	public void purge (int codeArt) {
		...
		Enumeration<UneCommande41<Integer>> cdeEnum =  tabCde.elements();	
		while(cdeEnum.hasMoreElements()){
			UneCommande41<Integer> cde = cdeEnum.nextElement();
		...
		for(UneCommande41<Integer> cde: tabCde.values()) {
	...
	public String facturerCommandes(TableArticle41 tabArt) {
		String sc = "\n\t\t LE TOTAL des COMMANDES \n";
		String sc2 = "";
		float prixTotalFacturesTTC=0;
		//Transformer une commande en collection
		//Collection<UneCommande41<Integer>>commandes = tabCde.values();
		//INTERFACE ENUMERATION - IL FAUT PASSER PAR UN ITERATEUR SINON UNE FOIS ON SUPPRIME UNE COMMANDE LE tabCde N EST PAS AU COURANT ET IL ENVOIE UNE ERREUR
				Enumeration<UneCommande41<Integer>> cdeEnum =  this.tabCde.elements();	
				while(cdeEnum.hasMoreElements()){
					UneCommande41<Integer> cde = cdeEnum.nextElement();
	...
	/*
		...
		for(UneCommande41<Integer> commande: tabCde.values()) {
			//Numéro de commande
